...
const HOLIDAY_DEFS: HolidayDef[] = [
  ...
  { name: "Heilige Drei Könige", date: (y) => new Date(y, 0, 6), regions: ["BW", "BY", "ST"] },
  { name: "Internationaler Frauentag", date: (y) => new Date(y, 2, 8), regions: ["BE", "MV"] },
  ...
  { name: "Christi Himmelfahrt", date: (_y, e) => addDays(e, 39), regions: "all" },
  { name: "Pfingstsonntag", date: (_y, e) => addDays(e, 49), regions: ["BB"] },
  { name: "Pfingstmontag", date: (_y, e) => addDays(e, 50), regions: "all" },
  { name: "Fronleichnam", date: (_y, e) => addDays(e, 60), regions: ["BW", "BY", "HE", "NW", "RP", "SL"] },
  { name: "Mariä Himmelfahrt", date: (y) => new Date(y, 7, 15), regions: ["SL"] },
  { name: "Tag der Deutschen Einheit", date: (y) => new Date(y, 9, 3), regions: "all" },
  { name: "Reformationstag", date: (y) => new Date(y, 9, 31), regions: ["BB", "HB", "HH", "MV", "NI", "SN", "ST", "SH", "TH"] },
  { name: "Allerheiligen", date: (y) => new Date(y, 10, 1), regions: ["BW", "BY", "NW", "RP", "SL"] },
  { name: "Buß- und Bettag", date: (y) => penanceDay(y), regions: ["SN"] },
  { name: "Weltkindertag", date: (y) => new Date(y, 8, 20), regions: ["TH"] },
  { name: "1. Weihnachtstag", date: (y) => new Date(y, 11, 25), regions: "all" },
  { name: "2. Weihnachtstag", date: (y) => new Date(y, 11, 26), regions: "all" },
];
