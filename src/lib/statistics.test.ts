...
describe("statistics", () => {
  const days = [
    day({ date: "2026-05-18", firstStart: "2026-05-18T08:00:00", netMinutes: 480, targetMinutes: 480, differenceMinutes: 0 }),
    day({ date: "2026-05-19", firstStart: "2026-05-19T09:00:00", netMinutes: 540, targetMinutes: 480, differenceMinutes: 60 }),
    day({ date: "2026-05-20", firstStart: "2026-05-20T10:00:00", netMinutes: 300, targetMinutes: 480, differenceMinutes: -180 }),
    day({ date: "2026-05-23", netMinutes: 0, targetMinutes: 0, differenceMinutes: 0 }), // freier Tag, ignoriert
  ];
